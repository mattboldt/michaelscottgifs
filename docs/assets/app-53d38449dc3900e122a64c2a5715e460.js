...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({tagName:"input",readonly:!0,value:"",attributeBindings:["value","readonly"],click:function(e){e.preventDefault(),Ember.$(this.get("element")).select()}})}),define("website/controllers/index",["exports"],function(e){"use strict"
...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(t){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("website/app").default.create({API_URL:"https://nkmi8emuul.execute-api.us-east-1.amazonaws.com/prod/michaelscottgifs_MichaelScott",name:"website",version:"0.0.0+17d14e4c"})
