...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({currentImage:"",searchQuery:"",apiUrl:t.default.APP.API_URL,didInsertElement:function(){this._super.apply(this,arguments),this.loadImage()},loadImage:function(){var e=this,t=this.get("apiUrl")+"?query="+this.get("searchQuery")
Ember.$.getJSON(t).then(function(t){Ember.run.bind(e,e.set("images",t))})},actions:{search:function(){this.loadImage(this.get("searchQuery"))}}})}),define("website/components/image-tags",["exports"],function(e){"use strict"
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({tagName:"input",readonly:!0,value:"",attributeBindings:["value","readonly"],click:function(e){e.preventDefault(),Ember.$(this.get("element")).select()}})}),define("website/helpers/app-version",["exports","website/config/environment","ember-cli-app-version/utils/regexp"],function(e,t,r){"use strict"
...
n="string"==typeof i?i:Ember.String.classify(t.default.modulePrefix),r[n]||(r[n]=e,e.reopen({willDestroy:function(){this._super.apply(this,arguments),delete r[n]}}))}}Object.defineProperty(e,"__esModule",{value:!0}),e.initialize=r,e.default={name:"export-application-global",initialize:r}}),define("website/initializers/injectStore",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default={name:"injectStore",before:"store",initialize:function(){}}})
define("website/initializers/metrics",["exports","website/config/environment"],function(e,t){"use strict"
...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(t){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("website/app").default.create({API_URL:"https://nkmi8emuul.execute-api.us-east-1.amazonaws.com/prod/michaelscottgifs_MichaelScott",name:"website",version:"0.0.0+39937135"})
