...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({searchQuery:"",apiUrl:t.default.APP.API_URL,pageTitle:Ember.computed("query",function(){var e=this.get("query")
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Controller.extend({queryParams:["q"],q:"",images:null})}),define("website/helpers/app-version",["exports","website/config/environment","ember-cli-app-version/utils/regexp"],function(e,t,r){"use strict"
...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(t){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("website/app").default.create({API_URL:"https://nkmi8emuul.execute-api.us-east-1.amazonaws.com/prod/michaelscottgifs_MichaelScott",name:"website",version:"0.0.0+69a92dc5"})
